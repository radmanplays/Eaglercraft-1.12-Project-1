...
public class AxisAlignedBB {
	...
	/**+
	 * Returns a bounding box expanded by the specified vector (if
	 * negative numbers are given it will shrink). Args: x, y, z
	 */
	 ...
	 * and Z dimensions, calculate the offset between them in the X
	 * dimension. return var2 if the bounding boxes do not overlap
	 * or if var2 is closer to 0 then the calculated offset.
	...
	/**+
	 * if instance and the argument bounding boxes overlap in the X
	 * and Z dimensions, calculate the offset between them in the Y
	 * dimension. return var2 if the bounding boxes do not overlap
	 * or if var2 is closer to 0 then the calculated offset.
	 * Otherwise return the calculated offset.
	 */
	...
	/**+
	 * if instance and the argument bounding boxes overlap in the Y
	 * and X dimensions, calculate the offset between them in the Z
	 * dimension. return var2 if the bounding boxes do not overlap
	 * or if var2 is closer to 0 then the calculated offset.
	 * Otherwise return the calculated offset.
	 */
	...
	/**+
	 * Returns whether the given bounding box intersects with this
	...
	/**+
	 * Returns if the supplied Vec3D is completely inside the
	 * bounding box
	 */
	...
	/**+
	 * Checks if the specified vector is within the YZ dimensions of
